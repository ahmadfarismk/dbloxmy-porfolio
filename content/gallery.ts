...
export const galleryItems: GalleryItem[] = [
  ...
  { title: "Jejak Wahyu — Key Art", category: "Games", src: "/projects/jejak-wahyu-cover.jpg", gradient: "from-amber-600 to-yellow-400" },
  { title: "PKSK Onboard — Key Art", category: "Games", src: "/projects/pksk-cover.jpg", gradient: "from-sky-500 to-cyan-400" },
  { title: "FinBlox — Key Art", category: "Games", src: "/projects/finblox-cover.png", gradient: "from-violet-600 to-fuchsia-500" },
